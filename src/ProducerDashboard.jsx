            ...
            <div className="rounded-2xl border border-slate-800/80 bg-slate-900/80 p-4 space-y-5 shadow-rb-gloss-panel">
              ...
              <div className="mt-4 rounded-xl border border-slate-800/80 bg-slate-900/90 p-4 text-xs">
                ...
                <p className="text-[11px] text-slate-400 mb-3">
                  Update your public store banner and social links, then preview how it looks to artists.
                </p>
                <div className="flex flex-col gap-3">
                  <a
                    href={`/profile/edit`}
                    className="inline-flex items-center gap-2 rounded-full border border-slate-700/80 bg-slate-800/80 px-3 py-1.5 text-[11px] font-medium text-slate-200 hover:border-emerald-400/70"
                  >
                    <span className="inline-flex h-4 w-4 items-center justify-center rounded-full bg-slate-900 text-[10px]">
                      🎨
                    </span>
                    <span>Edit banner &amp; branding</span>
                  </a>
                  <div className="flex flex-wrap gap-2 text-[11px] text-slate-300">
                    <span className="text-slate-400">Socials:</span>
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-[11px]">IG</span>
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-[11px]">TT</span>
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-[11px]">YT</span>
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-[11px]">Web</span>
                  </div>
                  <a
                    href={`/producer/${user.id}/store`}
                    className="inline-flex items-center gap-2 rounded-full bg-emerald-500 px-3 py-1.5 text-[11px] font-semibold text-slate-950 hover:bg-emerald-400"
                  >
