      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="mt-10 rounded-2xl border border-slate-800/80 bg-slate-900/80 p-6">
          ...
          <ul className="mt-4 grid gap-2 sm:grid-cols-2 text-[11px] text-slate-300">
            {['Pro badge','Unlimited uploads','Higher visibility ranking','Custom profile banners','Advanced analytics','Automated tagging','Playlist placement','Instant payout processing'].map(x => (
